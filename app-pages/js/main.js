...
var pages = new PageSlide(document.getElementById('pages'), 'Y', {
    tranSetionEnd: function() {
        // console.log(this.current);
        if ((this.move < 0) && (this.current == 0)) {
            App.set("$Cache.top.hide", true);
            console.log(true);
        }
        if ((this.move > 0) && (this.current == 1)) {
            App.set("$Cache.top.hide", false);
            console.log(false);
        }
    }
});
